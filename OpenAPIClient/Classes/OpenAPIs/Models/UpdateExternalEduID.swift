...
public struct UpdateExternalEduID: Codable, JSONEncodable, Hashable {
    ...
    public init(email: String? = nil, chosenName: String, firstName: String? = nil, lastNamePrefix: String? = nil, lastName: String, dateOfBirth: String? = nil, identifier: String, verification: Verification, brinCode: String? = nil, eduIDValue: String) {
        self.email = email
