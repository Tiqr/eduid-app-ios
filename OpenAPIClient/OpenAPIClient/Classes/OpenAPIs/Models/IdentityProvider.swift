...
public struct IdentityProvider: Codable, JSONEncodable, Hashable {
    ...
    public init(entityId: String? = nil, name: String? = nil, nameNl: String? = nil, institutionGuid: String? = nil, logoUrl: String? = nil, domainName: String? = nil, institutionBrin: String? = nil) {
