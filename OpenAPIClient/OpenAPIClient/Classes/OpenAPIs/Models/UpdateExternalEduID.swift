...
public struct UpdateExternalEduID: Codable, JSONEncodable, Hashable {
    ...
    /** Generated by the RemoteCreation POST API, must be send with PUT update requests */
    public var eduIDValue: String

    public init(email: String? = nil, chosenName: String, firstName: String? = nil, lastNamePrefix: String? = nil, lastName: String, dateOfBirth: String? = nil, identifier: String, verification: Verification, brinCodes: [String]? = nil, eduIDValue: String) {
        self.email = email
