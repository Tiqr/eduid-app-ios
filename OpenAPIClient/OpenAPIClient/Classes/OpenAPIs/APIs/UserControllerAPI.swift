...
open class UserControllerAPI {
    ...
    /**
     ...
     - parameter inApp: (query)  (optional, default to false)
     - returns: StatusResponse
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func createEduIDAccount(createAccount: CreateAccount, inApp: Bool? = nil) async throws -> StatusResponse {
        return try await createEduIDAccountWithRequestBuilder(createAccount: createAccount, inApp: inApp).execute().body
    }
     ...
     */
    open class func createEduIDAccountWithRequestBuilder(createAccount: CreateAccount, inApp: Bool? = nil) -> RequestBuilder<StatusResponse> {
        ...
        var localVariableUrlComponents = URLComponents(string: localVariableURLString)
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            "in-app": (wrappedValue: inApp?.encodeToJSON(), isExplode: true),
        ])
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func createUserControlCode(controlCode: ControlCode) async throws -> ControlCode {
        return try await createUserControlCodeWithRequestBuilder(controlCode: controlCode).execute().body
    }
    ...
    /**
     ...
     - :
       ...
       - name: openId
     - parameter controlCode: (body)  
     - returns: RequestBuilder<ControlCode> 
     */
    open class func createUserControlCodeWithRequestBuilder(controlCode: ControlCode) -> RequestBuilder<ControlCode> {
        let localVariablePath = "/mobile/api/sp/control-code"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: controlCode)
        ...
        let localVariableRequestBuilder: RequestBuilder<ControlCode>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func deleteUserControlCode() async throws -> UserResponse {
        return try await deleteUserControlCodeWithRequestBuilder().execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<UserResponse> 
     */
    open class func deleteUserControlCodeWithRequestBuilder() -> RequestBuilder<UserResponse> {
        let localVariablePath = "/mobile/api/sp/control-code"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters: [String: Any]? = nil
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func institutionalDomains() async throws -> [String] {
     ...
     */
    open class func institutionalDomainsWithRequestBuilder() -> RequestBuilder<[String]> {
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func institutionalDomains1() async throws -> [String] {
    ...
    /**
     ...
     - returns: RequestBuilder<[String]> 
     */
    open class func institutionalDomains1WithRequestBuilder() -> RequestBuilder<[String]> {
