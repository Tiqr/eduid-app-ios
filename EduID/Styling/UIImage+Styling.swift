...
extension UIImage {
    static let eduIDLogo = UIImage(named: "eduID_logo_vector")!
    ...
    static let qrCodeIcon = UIImage(named: "qr_code_icon")!
    ...
    static let surfLogo = UIImage(named: "surf_logo_vector")!
    ...
    static let verifyContactSupport = UIImage(named: "verify_contact_support")!
